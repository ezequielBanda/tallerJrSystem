...
<html>
    ...
    <body>
        ...
        <div id="content-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Informacion de la piza</h1>
                </div>
          
                     
                <div class="col-md-6 col-sm-6" >
                    <div style="top: 80px; left: 50px;  position: absolute;">
                    <img align=center src="imagenes/72693.jpg">
                    </div>
                </div>
               ...
               <br>
                <div style="top: 520px; left: 100px;  position: absolute;"> 
                    <br>
                    
                                   
                    <p><b>Codigo:</b> 72693 </p>
                    <p><b>Pieza:</b> Amoriguador Marca OESpctrum</p>
                    <p><b>Descripcion de la pieza:</b> Delantero Derecho</p>
                    <p><b>Modelos:</b> Acursa- TL 2009-2014 </P>
                    <p><b> Sucursal donde se encuentra:</b> La del leoncito calle 11</p>   
                    <p><b>Telefono:</b> 9-99-99-99</p>
                    <P><b>Precio:</b> $200</P>
                </div>
