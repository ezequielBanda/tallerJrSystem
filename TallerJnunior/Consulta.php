                                ...
                                <div class="widget">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="widget-content">
                                            ...
                                            <!--<div class="row">-->
                                            <div class="col-md-4">
                                                <label for="text-input">Codigo</label><br><br>
                                                <input  value=""  name="codigo" type="text"  required="required">
                                                <br><br>                     
                                                <label for="userName">Marca</label><br>
                                            ...
                                            <div class="col-md-4">  
                                                ...
                                                <br><br> 
                                                <input  value=""  name="sucursal" type="text"  required="required">
                                                <br><br>
                                            ...
                                            <div class="col-md-4">  
                                                ...
                                                <br><br> 
                                                <input  value=""  name="precio" type="text"  required="required">
                                                <br><br>
                                                <label for="userName">Fecha</label>
                                                <br>
                                                <input  value=""  name="fecha" type="text"  required="required">
